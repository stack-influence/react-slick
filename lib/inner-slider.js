...
var InnerSlider = (exports.InnerSlider = /*#__PURE__*/ (function(
  ...
  function InnerSlider(props) {
    ...
    _defineProperty(
      ...
      function() {
        ...
        if (window.addEventListener) {
          ...
          _this.list.addEventListener("touchstart", _this.swipeStart, {
            passive: false,
            signal: _this.abortController.signal
          });
          _this.list.addEventListener("touchmove", _this.swipeMove, {
            passive: false,
            signal: _this.abortController.signal
          });
          _this.list.addEventListener("touchend", _this.touchEnd, {
            passive: false,
            signal: _this.abortController.signal
          });
          _this.list.addEventListener("click", _this.clickHandler, {
            capture: true,
            signal: _this.abortController.signal
          });
        } else {
    ...
    _defineProperty(_assertThisInitialized(_this), "clickHandler", function(e) {
      console.log("click", _this.clickable);
